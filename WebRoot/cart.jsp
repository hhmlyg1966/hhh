<%@ page language="java" import="java.util.*,com.scmpi.book.dao.impl.*" pageEncoding="utf-8"%>
...
<%
	...
	//此处写入后台数据库购物车表，以便以后下单
	//下单写入订单项表时，利用触发器，把它删除
...
html>body td {
	...
	<body>
		...
		<div id="tabledata">
			...
			<br>
			<br>
			<input type="button" value="保存购物车信息" onclick="inCart()" />
